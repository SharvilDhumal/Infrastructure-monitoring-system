  ...
  return (
    <>
      <LoaderWrapper>
        ...
        <div className="relative bg-black dark:bg-black transition-colors pt-16 sm:pt-20">
          <Toaster />
          <Navbar />
          <Hero />
          <TrustedBy />
      ...
      {/* Custom Cursor Ring - Always visible, outside LoaderWrapper */}
      <div
        ref={outlineRef}
      ...
      {/* Custom Cursor Dot - Always visible, outside LoaderWrapper */}
      <div
        ref={dotRef}
